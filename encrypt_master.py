...
master_config_data = {
  "master_url": {
    ...
    "full_matches_replay_json_link": "https://reaepo1no3489repo34xserdqrtmmfbhdaej.pages.dev/matches.json",
    "tv_channels": "https://priv-bc7.pages.dev/tv.json",
    "predictions": "https://tyhdsjax-nfhbqsm.pages.dev/today_matches.json",
    "league_tables": "https://priv-bc7.pages.dev/standings.json",
    "live_scores": "https://priv-bc7.pages.dev/lvscore.json",
    "emthriyu": "https://priv-bc7.pages.dev/lovestory.json",
    "tv_chnnels_back_up": "https://priv-bc7.pages.dev/ads.json",
