        ...
        slim.append(
            {
                ...
                "home_team_short": normalize_text(event.get("home_team_short")),
                "away_team_short": normalize_text(event.get("away_team_short")),
                "home_team_slug": normalize_text(event.get("home_team_slug")),
                "away_team_slug": normalize_text(event.get("away_team_slug")),
                ...
                "competition_full": normalize_text(event.get("competition_full")),
